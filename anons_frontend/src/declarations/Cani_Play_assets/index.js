...
import { idlFactory } from './Cani_Play_assets.did.js';
export { idlFactory } from './Cani_Play_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANI_PLAY_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Cani_Play_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Cani_Play_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Cani_Play_assets.did.js")._SERVICE>}
 */
export const Cani_Play_assets = createActor(canisterId);
