...
import { idlFactory } from './anons_ic_frontend.did.js';
export { idlFactory } from './anons_ic_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ANONS_IC_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./anons_ic_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the anons_ic_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./anons_ic_frontend.did.js")._SERVICE>}
 */
export const anons_ic_frontend = createActor(canisterId);
