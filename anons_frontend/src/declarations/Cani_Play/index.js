...
import { idlFactory } from './Cani_Play.did.js';
export { idlFactory } from './Cani_Play.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANI_PLAY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Cani_Play.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Cani_Play canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Cani_Play.did.js")._SERVICE>}
 */
export const Cani_Play = createActor(canisterId);
